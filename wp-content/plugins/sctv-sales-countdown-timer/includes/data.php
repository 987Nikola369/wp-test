...
class VI_SCT_SALES_COUNTDOWN_TIMER_Data {
	...
	public function __construct() {
		...
		$coundown      = array(
			...
			'sale_countdown_sc_upcoming_message'           => array( 'Sale starts in {countdown_timer}' ),
			'sale_countdown_sc_elapsed_message'            => array( 'Sales have already elapsed from {schedule_time}' ),
			'sale_countdown_name'                          => array( 'Countdown timer' ),
			'sale_countdown_fom_date'                      => array( gmdate( "Y-m-d", current_time( 'timestamp' ) ) ),
		...
		$checkout      = array(
			...
			'checkout_countdown_action_after_finish'           => 'refresh_page',
	...
	public function set( $name ) {
		if ( is_array( $name ) ) {
			...
			return esc_attr__( $this->prefix . $name );// phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText
