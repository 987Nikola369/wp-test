...
visctv_countdown_timer_init.prototype.change_value = function (container) {
    ...
    container.on('change','.woo-sctr-countdown-template-6-value-width', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-6.woo-sctr-shortcode-countdown-unit-animation-slide .woo-sctr-countdown-value').css({'width': jQuery(this).val() + 'px'});
    });
    container.on('change','.woo-sctr-countdown-template-6-value-height', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-6.woo-sctr-shortcode-countdown-unit-animation-slide .woo-sctr-countdown-value').css({'height': jQuery(this).val() + 'px'});
    });
    ...
    container.on('change','.woo-sctr-countdown-template-7-value-width', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7.woo-sctr-shortcode-countdown-unit-animation-slide .woo-sctr-countdown-value-wrap').css({'width': jQuery(this).val() + 'px'});
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-flip-shadow-wrap').css({'width': jQuery(this).val() + 'px'});
    });
    container.on('change','.woo-sctr-countdown-template-7-value-height', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7.woo-sctr-shortcode-countdown-unit-animation-slide .woo-sctr-countdown-value-wrap').css({'height': jQuery(this).val() + 'px'});
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-flip-shadow-wrap').css({'height': jQuery(this).val() + 'px'});
    });
    container.on('change','.woo-sctr-countdown-template-7-value-border-radius', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-flip-up').css({'border-radius': + jQuery(this).val() + 'px ' + jQuery(this).val() + 'px 0 0'});
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-flip-down').css({'border-radius':  '0 0 ' + jQuery(this).val() + 'px ' + jQuery(this).val() + 'px'});
    });
    container.on('change', '.woo-sctr-countdown-template-7-value-fontsize',function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7.woo-sctr-shortcode-countdown-unit-animation-flip  .woo-sctr-countdown-flip-shadow-wrap').css({'font-size': jQuery(this).val() + 'px'});
    });
...
visctv_countdown_timer_init.prototype.color_picker = function (container) {
    ...
    container.on('change keyup','.woo-sctr-countdown-template-7-value-color1', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-unit-wrap .woo-sctr-countdown-flip-up').css({'color': jQuery(this).val()});
    });
    container.on('change keyup','.woo-sctr-countdown-template-7-value-background1', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-unit-wrap .woo-sctr-countdown-flip-up').css({'background': jQuery(this).val()});
    });
    container.on('change keyup','.woo-sctr-countdown-template-7-value-color2', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-unit-wrap .woo-sctr-countdown-flip-down').css({'color': jQuery(this).val()});
    });
    container.on('change keyup','.woo-sctr-countdown-template-7-value-background2', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-unit-wrap .woo-sctr-countdown-flip-down').css({'background': jQuery(this).val()});
    });
    container.on('change keyup','.woo-sctr-countdown-template-7-value-cut-color', function () {
        ...
        container.find('.woo-sctr-countdown-timer.woo-sctr-countdown-timer-7 .woo-sctr-countdown-unit-wrap .woo-sctr-countdown-flip-divider').css({'background': jQuery(this).val()});
    });
