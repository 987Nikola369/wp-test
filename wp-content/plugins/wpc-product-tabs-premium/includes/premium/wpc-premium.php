...
if ( ! function_exists( 'woost_update_checker' ) ) {
	...
	add_action( 'in_plugin_update_message-' . plugin_basename( WOOST_FILE ), 'woost_update_license', 99 );
	...
	function woost_update_checker() {
		if ( $key = wpc_get_update_key( 12537 ) ) {
			...
			PucFactory::buildUpdateChecker( 'https://api.wpclever.net/update/12537.json', WOOST_FILE, plugin_basename( WOOST_DIR ) );
		}
	}

	function woost_update_license( $plugin_data ) {
