...
! defined( 'WOOSC_PREMIUM' ) && define( 'WOOSC_PREMIUM', __FILE__ );
                                                    ...
                                                    <div class="woosc-fields-more">
                                                        <label> <select class="woosc-field-types">
																...
																if ( $wc_attributes = wc_get_attribute_taxonomies() ) {
																	...
																	echo '<option value="all" data-type="attribute">' . esc_html__( 'All attributes', 'woo-smart-compare' ) . '</option>';
						...
						foreach ( $products as $product_id ) {
							...
							foreach ( $fields as $key => $field ) {
								...
								if ( $field_type === 'attribute' ) {
									$product_attribute = $product_obj->get_attribute( $field_name );

									if ( empty( $product_attribute ) && $parent_product ) {
										$product_attribute = $parent_product->get_attribute( $field_name );
									}

									$products_data[ $product_id ][ $field_name ] = apply_filters( 'woosc_product_' . $field_name, $product_attribute, $product_obj );
								}
								...
								if ( $field_type === 'custom_field' ) {
									...
									if ( ( str_contains( $custom_field_cf, 'cf_wpcf' ) ) && is_array( $custom_field_val ) && ! empty( $custom_field_val ) ) {
									...
									$products_data[ $product_id ][ $custom_field_cf ] = apply_filters( 'woosc_product_' . $custom_field_cf, do_shortcode( str_replace( '{product_id}', $product_id, $custom_field_val ) ), $product_obj );
								}
